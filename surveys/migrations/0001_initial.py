# Generated by Django 4.2.3 on 2023-09-19 16:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', surveys.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Choice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey_progress', models.CharField(choices=[('not started', 'not started'), ('completed', 'completed'), ('incompleted', 'incompleted')], default='not started', max_length=250)),
                ('survey_date_taken', models.DateTimeField(blank=True, null=True)),
                ('survey_page_number', models.SmallIntegerField(blank=True, default=1, null=True)),
                ('cohort', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surveys.cohort')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pages', models.ManyToManyField(blank=True, to='surveys.page')),
            ],
        ),
        migrations.CreateModel(
            name='Response',
            fields=[
                ...
                ('multichoices', models.ManyToManyField(blank=True, related_name='multichoices', to='surveys.choice')),
